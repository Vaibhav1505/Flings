...
// import 'package:flings_flutter/components/Button/IconOnpressed.dart';
...
// import 'package:flings_flutter/components/Others/DragWidget.dart';
...
//   List<int> acceptedUser=[];
//   List<int> rejectedUser=[];
...
//   Future<void> acceptUser() async {
//     var data = {'receivedMessageString': 'This is sample message String'};

//     var res = await interceptedRequest.postHttp(ACCEPT_USER, data);
//     print("User Accepted");
//     print(res);
//   }
...
//             print("accepted");
//             acceptUser();
//             print('Accept User function runs successfully');
//             acceptedUser.add(index);
//             print("$index added to Accepted User List");
//             setState(() {
